...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  final List<String> _sizes = ['XL', 'XS', 'S', 'M', 'L'];
  int _selectedSize = 0;
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    // Rating text di atas, judul + stars di baris bawah (kanan)
                    Align(
  ...
  void _onOrderNow() {
    ...
    if (_panjangBajuC.text.isEmpty ||
        _lingkarDadaC.text.isEmpty ||
        _lingkarPinggangC.text.isEmpty ||
        _panjangLenganC.text.isEmpty) {
