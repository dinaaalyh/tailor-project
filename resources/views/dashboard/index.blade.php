                            ...
                            <table
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <!-- Produk -->
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                <img src="/assets/img/products/tee-basic-black.jpg"
                                                    class="w-10 h-10 rounded-lg object-cover" alt="Basic Tee Black">
                                                <div>
                                                    <h6 class="mb-0 text-sm font-semibold dark:text-white">Basic Tee –
                                                        Black</h6>
                                                    <p class="mb-0 text-xs text-slate-500 dark:text-slate-300">SKU:
                                                        BT-BLK-001</p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs dark:text-white">Size: S–XL • Color: Black</span>
                                        </td>

                                        <!-- Terjual (30d) -->
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs font-semibold dark:text-white">1,245</span>
                                        </td>

                                        <!-- Revenue -->
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs font-semibold dark:text-white">Rp 186.750.000</span>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="text-xs dark:text-white">78</span>
                                                <span
                                                    class="px-2 py-0.5 text-[10px] rounded-full bg-amber-100 text-amber-700">Low</span>
                                            </div>
                                        </td>
                                        ...
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs dark:text-white">2.1%</span>
                                        </td>
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center">
                                                <span class="mr-2 text-xs font-semibold text-emerald-600">+12%</span>
                                                <div class="relative w-24 h-1 bg-slate-200 rounded">
                                                    <div class="absolute h-1 rounded w-3/4 bg-emerald-500"></div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <div class="flex items-center gap-3">
                                                <img src="/assets/img/products/oxford-white.jpg"
                                                    class="w-10 h-10 rounded-lg object-cover"
                                                    alt="Oxford Shirt White">
                                                <div>
                                                    <h6 class="mb-0 text-sm font-semibold dark:text-white">Oxford Shirt
                                                        – White</h6>
                                                    <p class="mb-0 text-xs text-slate-500 dark:text-slate-300">SKU:
                                                        OX-WHT-210</p>
                                                </div>
                                        ...
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs dark:text-white">Size: M–XL • Color: White</span>
                                        </td>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs font-semibold dark:text-white">872</span>
                                        </td>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs font-semibold dark:text-white">Rp 261.600.000</span>
                                        </td>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <div class="flex items-center gap-2">
                                                <span class="text-xs dark:text-white">315</span>
                                                <span
                                                    class="px-2 py-0.5 text-[10px] rounded-full bg-emerald-100 text-emerald-700">OK</span>
                                            </div>
                                        </td>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <span class="text-xs dark:text-white">1.3%</span>
                                        </td>
                                        <td
                                            class="p-3 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <span class="mr-2 text-xs font-semibold text-rose-600">-5%</span>
                                                <div class="relative w-24 h-1 bg-slate-200 rounded">
                                                    <div class="absolute h-1 rounded w-2/5 bg-rose-500"></div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
